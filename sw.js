...
self.addEventListener('fetch',e=>{
  ...
  if(u.hostname.includes('googleapis.com')||u.hostname.includes('gstatic.com')||u.hostname.includes('firebaseio.com')||u.hostname.includes('firebase')){return;}
